...
**Projeto:** `B.MATTOS-ADESTRAMENTO`  
**Gerado em:** 2026-05-04 21:36:40  
**Total de arquivos:** 70  
**Raiz:** `C:\PROJETOS\SITE CLIENTES\B.MATTOS-ADESTRAMENTO`  
...
### `B.MATTOS-LINKS\.env.example`

```text
GTM_ID=
RESEND_API_KEY=re_Lnxf1qti_2TJj7HU659vak3ahDbE1pwXe
WHATSAPP_NUMBER=5511918952921
```

### `B.MATTOS-LINKS\.gitignore`
...
### `B.MATTOS-LINKS\astro.config.mjs`
...
### `B.MATTOS-LINKS\package.json`

```json
{
  "name": "beatriz-mattos-links",
  "type": "module",
  "version": "1.0.0",
  "engines": {
    "node": "20.x"
...
### `B.MATTOS-LINKS\project_snapshot.md`
...
### `B.MATTOS-LINKS\tailwind.config.js`
...
### `B.MATTOS-LINKS\_docs\BEATRIZ_MATTOS_DOC03_IMPLEMENTACAO.md`
...
### `B.MATTOS-LINKS\_docs\Briefing-Mentoria-Online-Beatriz-Mattos.md`
...
### `B.MATTOS-LINKS\_docs\implementação-lp.md`
...
### `B.MATTOS-LINKS\public\manifest.json`
...
### `B.MATTOS-LINKS\public\robots.txt`
...
### `B.MATTOS-LINKS\src\dump_project_v2.py`
...
### `B.MATTOS-LINKS\src\env.d.ts`

```typescript
/// <reference path="../.astro/types.d.ts" />
```

### `B.MATTOS-LINKS\src\components\Button.astro`
...
### `B.MATTOS-LINKS\src\components\ContactForm.tsx`
...
### `B.MATTOS-LINKS\src\components\CookieBanner.tsx`
...
### `B.MATTOS-LINKS\src\components\FeatureCard.astro`
...
### `B.MATTOS-LINKS\src\components\GTM.astro`
...
### `B.MATTOS-LINKS\src\components\Icon.astro`
...
### `B.MATTOS-LINKS\src\components\MobileMenu.tsx`
...
### `B.MATTOS-LINKS\src\components\SectionHeader.astro`
...
### `B.MATTOS-LINKS\src\components\StickyCTA.astro`
...
const wppUrl = 'https://wa.me/5511918952921?text=Oi%2C%20vi%20voc%C3%AA%20no%20Google%20e%20gostaria%20de%20saber%20mais%20sobre%20a%20mentoria%20de%20adestramento.'
---
...
### `B.MATTOS-LINKS\src\layouts\Layout.astro`
...
import assinatura from '../assets/assinatura-adsgator-fundo-escuro.svg';
...
const wppUrl =
  'https://wa.me/5511918952921?text=Oi%2C%20vi%20voc%C3%AA%20no%20Google%20e%20gostaria%20de%20saber%20mais%20sobre%20a%20mentoria%20de%20adestramento.';
...
>
  ...
  <footer class="bg-foreground py-20 px-5 xl:px-12 text-primary-foreground border-t-8 border-accent">
    <div class="max-w-content mx-auto">
      ...
      <div class="border-t border-primary-foreground/10 mt-20 pt-8 flex flex-col md:flex-row items-center md:justify-between gap-6">
        ...
        <a href="https://adsgator.com.br/" target="_blank" rel="noopener noreferrer" aria-label="Adsgator Website">
          <Image
            src={assinatura}
            alt="Assinatura AdsGator"
            width={120}
            height={20}
            loading="lazy"
            class="h-5 w-auto opacity-40"
          />
        </a>
      </div>
    </div>
...
### `B.MATTOS-LINKS\src\pages\index.astro`
...
const links = [
  {
    ...
    href: '#', // Placeholder
    variant: 'secondary',
    trackingId: 'links-portfolio',
    newTab: true,
  },
  {
    label: 'Assinar Minha Petição',
    href: '#', // Placeholder
    variant: 'secondary',
    trackingId: 'links-petition',
    newTab: true,
  },
  {
    label: 'Visitar Minha Loja Online',
    href: '#', // Placeholder
    variant: 'secondary',
    trackingId: 'links-store',
    newTab: true,
  },
  {
    label: 'Entrar em Contato',
    href: wppUrl, // Reusing existing WhatsApp URL for contact
    variant: 'accent', // Keep accent for contact
    trackingId: 'links-contact',
    newTab: true,
  },
];
---
...
<body class="bg-green-100 text-foreground antialiased min-h-screen flex flex-col items-center justify-start pt-16 px-5 pb-12">
  ...
  <div class="w-full max-w-[520px] mx-auto flex flex-col items-center gap-8">
    ...
    <div class="relative">
      <Image
        ...
        height={96}
        loading="eager"
        class="rounded-full object-cover border-4 border-white shadow-card"
      />
    </div>

    <!-- Nome e Profissão -->
    <h1 class="font-sans text-2xl font-bold text-foreground text-center">Beatriz Mattos</h1>
    <p class="font-sans text-sm text-muted-foreground text-center uppercase tracking-widest">Adestradora</p>
    ...
    <div class="mt-4 flex gap-6">
      <a href="#" class="text-muted-foreground hover:text-accent transition-colors" aria-label="TikTok">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          <path d="M21 8V2h-8c-1.14 0-2 .86-2 2v10c0 1.14.86 2 2 2h8v-8zM10 2v10c0 1.14-.86 2-2 2H2V2h8z"/>
        </svg>
      </a>
      <a href="#" class="text-muted-foreground hover:text-accent transition-colors" aria-label="YouTube">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          <path d="M2.5 17.5v-11A1.5 1.5 0 0 1 4 5h16a1.5 1.5 0 0 1 1.5 1.5v11a1.5 1.5 0 0 1-1.5 1.5H4a1.5 1.5 0 0 1-1.5-1.5Z"/><path d="M10 9.5l5 2.5-5 2.5Z"/>
        </svg>
      </a>
      <a href="#" class="text-muted-foreground hover:text-accent transition-colors" aria-label="Twitter">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17-19 11.6 0 0 3.4 1.2 6.6 1.2 7 0 12.5-6.6 12.5-16.6 0-.3 0-.5 0-.8C19.8 6.5 21.4 4.8 22 4Z"/>
        </svg>
      </a>
      <a href="#" class="text-muted-foreground hover:text-accent transition-colors" aria-label="Facebook">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
        </svg>
      </a>
      <a href="#" class="text-muted-foreground hover:text-accent transition-colors" aria-label="Instagram">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          <rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/>
        </svg>
      </a>
...
### `B.MATTOS-LINKS\src\pages\api\contato.ts`
...
### `B.MATTOS-LINKS\src\sections\CTAFinalSection.astro`
...
<section
  id="cta-final"
  class="bg-foreground py-section-mobile-py xl:py-section px-5 xl:px-12 relative overflow-hidden border-t-8 border-accent"
>
  <!-- Background Noise -->
  ...
  <div class="max-w-content mx-auto text-center flex flex-col items-center gap-10 relative z-10">
    <h2 class="font-display text-h1 text-white leading-none uppercase max-w-[930px]">
    ...
    <div class="relative mt-6">
      <Button
        ...
        section="cta-final"
        newTab={true}
        class="px-8 sm:px-16 py-6 text-h3 tracking-[0.2em] border-2 border-foreground"
      />
    </div>

    <p class="font-display text-label text-accent tracking-[0.3em] mt-[-1.5rem] uppercase font-bold">
...
### `B.MATTOS-LINKS\src\sections\ComoFuncionaSection.astro`
...
<section
  id="como-funciona"
  class="bg-background py-section-mobile-py xl:py-section px-5 xl:px-12 border-b-2 border-foreground"
>
  <div class="max-w-content mx-auto">
    <div class="grid grid-cols-1 xl:grid-cols-[1fr_1.5fr] gap-12 xl:gap-20">
      ...
      <div class="flex flex-col gap-0 steps-stack-container">
        {passos.map((p, index) => (
          ...
          >
            <span class="font-display text-display text-foreground opacity-5 absolute right-8 top-4 pointer-events-none select-none">
              {p.num}
            </span>
        ...
        <div 
          class="sticky bg-foreground text-white p-10 xl:p-14 border-4 border-foreground shadow-[8px_8px_0px_0px_rgba(255,77,0,1)] z-[10] mb-20"
          style="top: 120px;"
        >
...
<script>
  ...
  if (!window.matchMedia('(prefers-reduced-motion: reduce)').matches) {
    ...
    cards.forEach((card, i) => {
      // Anima o card atual quando o próximo card se aproxima/sobrepõe
      gsap.to(card, {
        scale: 1, // Mantém escala em 1 para não desalinhar as bordas laterais
        opacity: 0.5,
...
### `B.MATTOS-LINKS\src\sections\ContatoSection.astro`
...
<section
  id="contato"
  class="bg-background py-section-mobile-py xl:py-section px-5 xl:px-12 relative border-b-2 border-foreground"
  ...
  <div class="max-w-content mx-auto relative z-10">
    <div class="grid grid-cols-1 xl:grid-cols-[1fr_500px] gap-20">
      ...
      <div class="bg-background border-4 border-foreground p-8 shadow-[12px_12px_0px_0px_rgba(26,29,35,1)]">
        <ContactForm client:load whatsappFallback={wppUrl} />
      </div>
    </div>
  </div>
</section>
...
### `B.MATTOS-LINKS\src\sections\DiferenciaisSection.astro`
...
<section
  id="diferenciais"
  class="bg-surface py-section-mobile-py xl:py-section px-5 xl:px-12 border-b-2 border-foreground overflow-hidden"
  ...
  <div class="max-w-content mx-auto">
    <div class="xl:grid xl:grid-cols-[1.2fr_0.8fr] gap-20 items-center">
      ...
      <div class="relative mt-20 xl:mt-0">
        ...
        />
        <div class="absolute -bottom-10 -left-10 font-hand text-hand-lg text-accent rotate-[-6deg] bg-background px-4 py-2 border-2 border-foreground shadow-card">
...
### `B.MATTOS-LINKS\src\sections\FAQSection.astro`
...
<section
  id="faq"
  class="bg-surface py-section-mobile-py xl:py-section px-5 xl:px-12 border-b-2 border-foreground"
...
### `B.MATTOS-LINKS\src\sections\HeroSection.astro`
...
import heroImageMobile from '../assets/images/hero-principal-mobile.webp';
...
<section
  id="hero"
  class="bg-background pt-[10rem] pb-section-mobile-py xl:pt-[14rem] xl:pb-section px-5 xl:px-12 relative"
>
  ...
  <div class="max-w-content mx-auto relative z-10">
    <div class="xl:grid xl:grid-cols-[1fr_540px] xl:gap-x-12 xl:items-start">
      ...
      <div class="flex flex-col gap-8 xl:gap-16">
        <div class="max-w-[1000px]">
          ...
          <div class="relative inline-block xl:-mt-4">
            <span class="font-hand text-h3 xl:text-hand-lg text-accent rotate-[-4deg] whitespace-nowrap bg-background px-4 py-1 border-2 border-foreground shadow-card z-20">
        ...
        <div class="relative flex flex-col gap-6 xl:gap-6 xl:max-w-[620px] xl:pb-12">
          ...
          <div class="relative w-full mt-4 xl:mt-0">
            ...
            <!-- Imagem Mobile -->
            <div class="hero-image-animate block xl:hidden w-full z-10 pointer-events-none">
              <Image
                src={heroImageMobile}
                ...
                loading="eager"
                format="webp"
                class="w-full h-auto drop-shadow-2xl translate-x-[2%]"
              />
            </div>
      ...
      <div id="hero-image-wrapper" class="hero-image-animate hidden xl:block relative xl:mt-[-40px] xl:-mr-12 z-20 group cursor-crosshair">
        ...
        <Image
          ...
          loading="eager"
          format="webp"
          class="w-full max-w-[520px] ml-auto drop-shadow-2xl transition-all duration-700"
        />
...
### `B.MATTOS-LINKS\src\sections\PlanosSection.astro`
...
<section
  id="planos"
  class="bg-foreground py-section-mobile-py xl:py-section px-5 xl:px-12 border-y-8 border-accent relative"
>
  <div class="max-w-content mx-auto relative z-10">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
      {listaPlanos.map((plano) => (
        <div class={`relative flex flex-col bg-background border-4 p-8 xl:p-10 ${plano.highlight ? 'border-accent' : 'border-white/10 hover:border-white transition-colors'}`}>
          ...
          <div class="mb-8">
            <div class="flex items-baseline gap-1">
              ...
              <span class="font-display text-display leading-none text-foreground">{plano.preco}</span>
...
### `B.MATTOS-LINKS\src\sections\ServicosSection.astro`
...
<section
  id="servico"
  class="bg-surface py-section-mobile-py xl:py-section px-5 xl:px-12 border-y-2 border-foreground relative z-10"
>
  <div class="max-w-content mx-auto">
    <div class="max-w-narrow mb-16">
      <SectionHeader
...
### `B.MATTOS-MENTORIA\astro.config.mjs`
...
### `B.MATTOS-MENTORIA\package.json`
...
### `B.MATTOS-MENTORIA\project_snapshot.md`
...
### `B.MATTOS-MENTORIA\tailwind.config.js`
...
### `B.MATTOS-MENTORIA\_docs\BEATRIZ_MATTOS_DOC03_IMPLEMENTACAO.md`
...
### `B.MATTOS-MENTORIA\_docs\Briefing-Mentoria-Online-Beatriz-Mattos.md`
...
### `B.MATTOS-MENTORIA\_docs\implementação-lp.md`
...
### `B.MATTOS-MENTORIA\public\manifest.json`
...
### `B.MATTOS-MENTORIA\public\robots.txt`
...
### `B.MATTOS-MENTORIA\src\dump_project_v2.py`
...
### `B.MATTOS-MENTORIA\src\env.d.ts`
...
### `B.MATTOS-MENTORIA\src\components\Button.astro`
...
### `B.MATTOS-MENTORIA\src\components\ContactForm.tsx`
...
### `B.MATTOS-MENTORIA\src\components\CookieBanner.tsx`
...
### `B.MATTOS-MENTORIA\src\components\FeatureCard.astro`
...
### `B.MATTOS-MENTORIA\src\components\GTM.astro`
...
### `B.MATTOS-MENTORIA\src\components\Icon.astro`
...
### `B.MATTOS-MENTORIA\src\components\MobileMenu.tsx`
...
### `B.MATTOS-MENTORIA\src\components\SectionHeader.astro`
...
### `B.MATTOS-MENTORIA\src\components\StickyCTA.astro`
...
### `B.MATTOS-MENTORIA\src\layouts\Layout.astro`
...
import StickyCTA from '../components/StickyCTA.astro';
import assinatura from '../assets/assinatura-adsgator-fundo-escuro.svg';
import heroPreload from '../assets/images/hero-principal.webp';
...
<head>
  ...
  <!-- Performance: preload hero image -->
  <!-- <link rel="preload" href={heroPreload.src} as="image" fetchpriority="high" /> -->
...
### `B.MATTOS-MENTORIA\src\pages\404.astro`
...
const pageTitle = "404 . Página não encontrada | Beatriz Mattos";
const pageDescription = "Ops! Parece que você se perdeu. A página que você procura não existe.";

const wppUrl =
  'https://wa.me/5511918952921?text=Ol%C3%A1%2C%20Beatriz!%20Vi%20o%20site%20e%20quero%20saber%20mais%20sobre%20a%20mentoria.%20Seguem%20minhas%20informa%C3%A7%C3%B5es%3A%20Ra%C3%A7a%3A%20%7C%20Idade%20do%20c%C3%A3o%3A%20%7C%20Principal%20problema%20comportamental%3A%20%7C%20Hist%C3%B3rico%20de%20adestramento%3A%20%7C%20Estou%20disposto%20a%20mudar%20a%C2%A0rotina%3A';
---

<Layout title={pageTitle} description={pageDescription} robots="noindex" canonicalUrl="https://mentoria.abeak9adestramento.com.br/404" hideNavLinks={true}>
  <main class="relative z-10 flex flex-col items-center justify-center text-center py-section-mobile-py xl:py-section px-5 max-w-content mx-auto min-h-[70vh]">
    <!-- Numeral decorativo -->
    <div class="num-404 font-display text-[30vw] text-foreground opacity-[0.04] absolute inset-0 flex items-center justify-center pointer-events-none select-none leading-none z-0">
      404
    </div>
    ...
    <div class="relative z-10 flex flex-col items-center gap-8 max-w-md">
      ...
      <div class="flex flex-col gap-4">
        <h1 class="font-display text-h2 text-foreground">Esse endereço não existe.</h1>
...
### `B.MATTOS-MENTORIA\src\pages\index.astro`
...
<Layout
  ...
  canonicalUrl="https://mentoria.abeak9adestramento.com.br"
>
  <HeroSection />
  <ServicosSection />
  <ComoFuncionaSection />
...
### `B.MATTOS-MENTORIA\src\pages\politica-de-privacidade.astro`
...
const pageTitle = "Política de Privacidade | Beatriz Mattos";
const pageDescription = "Política de Privacidade e Termos de Uso de Beatriz Mattos Adestradora.";
---

<Layout title={pageTitle} description={pageDescription} canonicalUrl="https://mentoria.abeak9adestramento.com.br/politica-de-privacidade" hideNavLinks={true}>
  <main class="max-w-narrow mx-auto py-16 px-5 xl:max-w-content xl:py-section">
    <article class="prose prose-slate max-w-none dark:prose-invert">
      <section id="privacidade" class="mb-16">
        <h1 class="font-display text-h2 mb-8">Política de Privacidade</h1>
        ...
        <div class="space-y-6 font-sans text-body leading-relaxed text-foreground/80">
          ...
          <h3 class="font-display text-h3 mt-8">1. Coleta de Informações</h3>
          <p>
          ...
          <h3 class="font-display text-h3 mt-8">2. Uso das Informações</h3>
          <p>
          ...
          <h3 class="font-display text-h3 mt-8">3. Cookies e Rastreamento</h3>
          <p>
          ...
          <h3 class="font-display text-h3 mt-8">4. Compartilhamento de Dados</h3>
          <p>
          ...
          <h3 class="font-display text-h3 mt-8">5. Seus Direitos (LGPD)</h3>
          <p>
      ...
      <section id="termos">
        <h2 class="font-display text-h2 mb-8">Termos de Uso</h2>
        
        <div class="space-y-6 font-sans text-body leading-relaxed text-foreground/80">
          <h3 class="font-display text-h3 mt-8">1. Objeto</h3>
          <p>
          ...
          <h3 class="font-display text-h3 mt-8">2. Condições do Serviço</h3>
          <p>
          ...
          <h3 class="font-display text-h3 mt-8">3. Responsabilidades</h3>
          <p>
          ...
          <h3 class="font-display text-h3 mt-8">4. Contato</h3>
          <p>
...
### `B.MATTOS-MENTORIA\src\pages\api\contato.ts`
...
### `B.MATTOS-MENTORIA\src\sections\CTAFinalSection.astro`
...
### `B.MATTOS-MENTORIA\src\sections\ComoFuncionaSection.astro`
...
### `B.MATTOS-MENTORIA\src\sections\ContatoSection.astro`
...
### `B.MATTOS-MENTORIA\src\sections\DiferenciaisSection.astro`
...
### `B.MATTOS-MENTORIA\src\sections\FAQSection.astro`
...
### `B.MATTOS-MENTORIA\src\sections\HeroSection.astro`
    ...
    <div class="xl:grid xl:grid-cols-[1fr_540px] xl:gap-x-12 xl:items-start">
      ...
      <div class="flex flex-col gap-8 xl:gap-16">
        <div class="max-w-[1000px]">
          ...
          <div class="relative flex">
            <span class="inline-block font-hand text-h3 xl:text-hand-lg text-accent rotate-[-6deg] xl:rotate-[-4deg] whitespace-nowrap bg-background px-4 py-1 border-2 border-foreground shadow-card z-20">
              fale a língua do seu cão
            </span>
          </div>
        </div>
      ...
      <div id="hero-image-wrapper" class="hero-image-animate hidden xl:block relative xl:mt-[-40px] xl:-mr-12 z-20 group cursor-crosshair">
        ...
        <Image
          ...
          loading="eager"
          format="webp"
          class="w-full max-w-[590px] ml-auto drop-shadow-2xl transition-all duration-700"
        />
...
### `B.MATTOS-MENTORIA\src\sections\PlanosSection.astro`
      ...
      {listaPlanos.map((plano) => (
        <div class={`relative flex flex-col bg-background border-4 p-8 xl:p-10 ${plano.highlight ? 'border-accent' : 'border-white/10 hover:border-white transition-colors'}`}>
          ...
          <div class="mt-12">
            <Button
              label="QUERO COMEÇAR"
              href={`https://wa.me/5511918952921?text=Oi%2C%20vi%20voc%C3%AA%20no%20Google%20e%20gostaria%20de%20saber%20mais%20sobre%20a%20mentoria%20de%20adestramento.%20Gostei%20do%20plano%20de%20R%24${plano.preco}%20por%20m%C3%AAs.`}
              variant={plano.highlight ? 'accent' : 'primary'}
              trackingId={`btn-plan-${plano.id}`}
              section="planos"
              newTab={true}
...
### `B.MATTOS-MENTORIA\src\sections\ServicosSection.astro`
